...
type Pkcs7 struct {
	...
	// spec
	// Required: true
	Spec Pkcs7Schema `json:"spec"`
}

// Kind gets the kind of this subtype
func (m *Pkcs7) Kind() string {
	return "pkcs7"
}

// SetKind sets the kind of this subtype
func (m *Pkcs7) SetKind(val string) {
}

// UnmarshalJSON unmarshals this object with a polymorphic type from a JSON structure
func (m *Pkcs7) UnmarshalJSON(raw []byte) error {
	var data struct {
...
func (m Pkcs7) MarshalJSON() ([]byte, error) {
	var b1, b2, b3 []byte
	var err error
...
// Validate validates this pkcs7
func (m *Pkcs7) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Pkcs7) validateAPIVersion(formats strfmt.Registry) error {
...
func (m *Pkcs7) validateSpec(formats strfmt.Registry) error {
...
func (m *Pkcs7) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Pkcs7) UnmarshalBinary(b []byte) error {
	var res Pkcs7
